		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="comment-top mt-5">
				<div class="comment-bottom mobamuinfo_mail_grid_right">
					<form  method="post" name="form1" action="ownerregpro.php">
						<div class="row">
...
?>
						...
						<div class="row">
							<div class="col-lg-6 form-group">
								...
								<select  name="Choose paint" class="form-control">
									   <option value="0">--Select--</option>
    <option value="thrissur">Red</option>
    <option value="kottayam">Blue</option>
	  <option value="palakad">Black</option>
	  <option value="thrissur">Gray</option>
    <option value="kottayam">Silver</option>
							...
							<div class="col-lg-6 form-group">
								...
								<input class="form-control" type="date" name="oname" >
							</div>
						</div>
							<div class="col-lg-6 form-group">
								<label>House Name</label>
								<input class="form-control" type="text" name="oname"  placeholder="House Name" >
								
							</div>
							<div class="col-lg-6 form-group">
								<label>Pin</label>
								<input class="form-control" type="text" name="oname" placeholder="Pin">
								
							</div>
							
							<div class="col-lg-6 form-group">
								<label>Time</label>
								<input class="form-control" type="time" name="oname"  placeholder="Time">
								
							</div>
							<div class="col-lg-6 form-group">
								<label>Mobile Number</label>
								<input class="form-control" type="text" name="oname"  placeholder="Mobile Number" >
