...
<body>
		...
		<header>
			<div class="container-fluid">
				<div class="header d-md-flex justify-content-between align-items-center py-3 px-xl-5 px-lg-3 px-2">
					<!-- logo -->
					<div id="logo">
						<h1><a href="../home.php">MERCEDES BENZ</a><img src="../symbol3 - Copy.png" style="position:relative;margin-left:10px;top:-18px; width:40px;"/></h1>
					</div>
					<!-- //logo -->
					<!-- nav -->
					<div class="nav_w3ls">
	...
	<div class="breadcrumb-mobamu">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">MECEDES PAINTING BOOKING</li>
		</ol>
	</div>
	<!-- //page details -->
	...
	<div class="register-w3 py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="tittle text-center text-bl font-weight-bold">MECEDES PAINTING BOOKING</h3>
			
			<div class="comment-top mt-5">
				<div class="comment-bottom mobamuinfo_mail_grid_right">
					<form  method="post" name="frmreg">
						<div class="row">
...
?>
							...
							<div class="col-lg-6 form-group">
								...
								<input class="form-control" type="text" name="txtuname"  value="<?php echo $_SESSION["email"]; ?>" readonly="true"  />
						...
						<div class="row">
							<div class="col-lg-6 form-group">
								<label>Choose Paint</label>
								<select  name="paint" class="form-control">
    ...
    <option value="Silver">Silver</option>
			...
			?>
								...
								<input class="form-control" min=<?php echo $cdate; ?> type="date" name="txtdate" >
							</div>
							...
							<div class="col-lg-6 form-group">
								<label>Pin</label>
								<input class="form-control" type="text" name="txtpin" value="<?php echo $_SESSION["pin"];?>" onChange="fn_checkpin(document.frmreg.txtpin);">
							...
							<div class="col-lg-6 form-group">
								...
								<input class="form-control" type="text" name="txtmobile"  value="<?php echo $_SESSION["mobile"];?>" readonly="true"/>
...
<?php
	...
	if(isset($_POST["btnsubmit"]))
	{
		...
		$obj->execute("insert into paint values(null,'$paint','$txtdate','$txttime', '$txtuname', '$model')");
		...
		$res=$obj->execute("select max(pid) as pid from paint where uname='". $_SESSION["email"] ."'");
	if($row=mysqli_fetch_array($res))
	{
		$_SESSION["pid"]=$row["pid"];
	}	
		$msg="Your Booking for the vehicle '$mname' with color '$paint' will take place on '$txtdate' at '$txttime'";
		SendEmail($msg);
		$obj->redirect("bill/bill_p.php");
