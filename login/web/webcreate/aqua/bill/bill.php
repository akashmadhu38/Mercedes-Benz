...
<html lang="en">
   ...
   <body>
      ...
      <div class="main-bothside">
		 ...
		 $res=$obj->execute("select * from topup,benzmodel,register where topup.modelid=benzmodel.modelID and register.email=topup.uname and topup.tpid='". $_SESSION["tpid"] ."'");
		 ...
		 ?>
            ...
            <div class="parent-clss">
               <div class="personal-info">
                  <p>Booking Date</p>
                 <div class="form-mid-w3ls">
                      <input type="text" name="scheme" readonly="true" value="<?php echo $row["tdate"]; ?>" placeholder="Scheme" required="">
                  </div>
               </div>
               <div class="personal-info">
                  <p>Time</p>
               ...
               <div class="personal-info">
                  <p>Complaint</p>                   
                  <div class="form-mid-w3ls">
                      <input type="text" name="ddate" readonly="true" placeholder="Delivery Date" value="<?php echo $row["complaint"]; ?>" required="">
                  </div>
               </div>
            </div>
            <div class="form-group">
