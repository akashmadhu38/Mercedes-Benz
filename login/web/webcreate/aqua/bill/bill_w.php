...
<html lang="en">
   ...
   <body>
      ...
      <div class="main-bothside">
		 ...
		 $res=$obj->execute("select * from carwash,benzmodel,register where carwash.modelid=benzmodel.modelID and register.email=carwash.uname and carwash.cwid='". $_SESSION["cwid"] ."'");
		 ...
		 ?>
            ...
            <div class="form-group">
               ...
               <div class="form-mid-w3ls">
                 <input type="text" name="amount" readonly="true" value="Rs. 1000/-" placeholder="Amount">
               </div>
            </div>
            <div class="form-group">
               <div class="form-mid-w3ls">
