...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2019 at 06:41 AM
...
CREATE TABLE IF NOT EXISTS `addboat` (
...
CREATE TABLE IF NOT EXISTS `boattoplan` (
...
(14, 1, 2, 'Debit card', '2019-10-12', '762', '27000 ', '2019-10-10');
...
(7, '24300', 2, '08/10/2019', 7, 'Jalarani');
