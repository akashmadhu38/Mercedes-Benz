...
<tr bgcolor="#6699CC" height="40"><td colspan="2" align="center">CHANGE PASSWORD</td></tr><TR>
<td> <b>Enter New Password </td>
<td><input type="password" name="npw" required placeholder="Enter new password" size="50" style="height:40px "></td>
</tr>
<tr>
<td><b>Confirm Password </td>
<td><input type="password" name="cpw" required placeholder=" Enter again new password" size="50" style="height:40px "></td>
