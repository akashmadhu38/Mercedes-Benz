...
.bgimg {background-image: url("MBCAN-2018-GLC-AMG-COUPE-CLASS-HERO-CH1-DR.jpg")}
...
<div class="w3-bottom w3-hide-small">
  <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
    ...
    <a href="#us" style="width:25%" class="w3-bar-item w3-button">ABOUT GLC</a>
...
<div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min" id="us">
  <div class="w3-content">
    ...
    <img class="w3-round w3-grayscale-min" src="MBCAN-2018-GLC-SUV-CLASS-HERO-CH1-DR.jpg" style="width:100%;margin:32px 0">
