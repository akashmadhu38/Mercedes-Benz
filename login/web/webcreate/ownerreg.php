...
<body>
	...
	<div class="breadcrumb-mobamu">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Owner registeration Form</li>
		</ol>
	</div>
	<!-- //page details -->
	...
	<div class="register-w3 py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="tittle text-center text-bl font-weight-bold">Owner Registeration</h3>
