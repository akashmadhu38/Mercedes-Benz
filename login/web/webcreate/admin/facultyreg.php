...
<?php
	...
	$bookingid="";
	$res=$obj->execute("select max(stID)+1 as sid from stock");
...
<table width="100%">
  ...
  <tr>
    <td colspan="3" class="heading">ADDING VEHICELS</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Stock ID</td>
    <td><input type="text" name="txtuname" value="<?php echo $bookingid; ?>"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>Class Name</td>
...
?></td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Number Of Vehicels</td>
    <td><input type="text" name="txtpswd"/></td>
  </tr>
...
$obj=new connection();
extract($_POST);
$sql1="select * from stock where stID='$txtuname'";
...
else
{
 ...
 $sql3="insert into stock values(null,'class','model','$txtdes','$txtpwd')";
$obj->execute($sql3);
?>
