...
<table width="100%">
<tr>
<td colspan="3" class="heading">approved vehicles</td>
</tr>
<tr>
  <td colspan="3">&nbsp;</td>
</tr>
...
<td>
	<table width="100%">
		...
		<?php
			...
			$res=$obj->execute("select * from addvehicle,addmodel,addcompany where addvehicle.modelid=addmodel.modelid and addvehicle.cmpid=addcompany.cmpid and addmodel.cmpid=addcompany.cmpid and addvehicle.status!='disapprove'");
			...
			?>				
				<tr>
					...
					<td><a href="viewvehicle_ad.php?vid=<?php echo $row["vehicleid"];?>">VIEW DETAILS</a>  </td>
				</tr>
