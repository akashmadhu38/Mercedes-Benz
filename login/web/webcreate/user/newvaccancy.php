...
<table width="100%">
<tr>
<td colspan="3" class="heading">new vaccancies</td>
</tr>
<tr>
  <td colspan="3">&nbsp;</td>
</tr>
...
<td>
	<table width="100%">
		...
		<?php
			...
			$rcount=0;
			$res=$obj->execute("select * from vaccancy,company where vaccancy.cmpid=company.cmpid and vaccancy.status='approved'");
			...
			{			
				if ($rcount % 4 != 0)
				{
					...
					<tr><td align="center"><a class="button" href="applynow.php?vid=<?php echo $row["vid"];?>">APPLY NOW</a>  </td></tr>
					</table>					
					</td>
