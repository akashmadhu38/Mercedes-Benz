...
<?php
	...
	$bookingid="";
	$res=$obj->execute("select max(ACCID)+1 as acid from accessories");
	$accid=0;
...
<table align="center" width="100%">
  <tr>
    <td colspan="3" class="heading">MERCEDES ACCESSORY BOOKING</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>ACCESSORY ID</td>
...
?>
	...
	<input type="text" name="accno" readonly="true" value="<?php echo $row["accno"];; ?>" />
  </tr>
  <?php
  }
  ?></td>
  <tr>
    <td>&nbsp;</td>
    <td>ACCESSORY BOOKING ID</td>
    <td><input type="text" name="accid" readonly="true" value="<?php echo $bookingid; ?>" /></td>
  </tr>
...
if($total!=0)
{
echo "<select acid='modelID' name='model' modelName='modelName' onchange='ajaxFunction()'>";
...
?>
  ...
  <tr>
	...
	if(isset($_POST["btnsubmit"]))
	{
		...
		//accno accid txtuname txtdob txthname txtloc txtpin txtmob model
		
	extract($_POST);	 
		//ACCID	uname	price	accno	modelID	status
	$sql3="insert into accessories values(null,'". $_SESSION["email"] ."','$price','$accno','$model','pending')";
	$obj->execute($sql3);
