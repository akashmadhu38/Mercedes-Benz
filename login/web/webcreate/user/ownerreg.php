...
?>
							...
							<div class="col-lg-6 form-group">
								...
								<input class="form-control" type="text" name="oname"  placeholder="Owner name">
							</div>
						</div>
						<div class="row">
							<div class="col-lg-6 form-group">
								<label>License No.Ref</label>
								<input class="form-control" type="text"  name="lic"  placeholder="Your licenseno">
							</div>
							<div class="col-lg-6 form-group">
    ...
    <option value="kottayam">Kottayam</option>
	  <option value="palakad">Palakad</option>
							...
							<div class="col-lg-6 form-group">
								...
								<input class="form-control" type="text"  name="place" placeholder="Your place">
							</div>
							<div class="col-lg-6 form-group">
