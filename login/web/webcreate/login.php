  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#tour">OWNERSHIP</a></li>
        <li><a href="#contact">MERCEDES-BENZ WORLD</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">MORE
          <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="#">REGISTER</a></li>
            <li><a href="webcreate/login1.php">LOGIN</a></li>
           </ul>
        </li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="mercedes-benz-wallpapers-32416-8660693.jpg" alt="New York" width="1200" height="700">
        <div class="carousel-caption">
          <p>Make the best of every ground</p>
		  <h2>Mercedes-Benz GLC</h2>
        </div>      
      </div>

      <div class="item">
        <img src="Mercedes-Benz-Wallpaper-44-1920x1200.jpg" alt="" width="1200" height="700">
        <div class="carousel-caption">
		 <h1>Convenience, now at your fingertips</h1>
		 <p>>Enjoy transparency on our services with Online Service Estimate</p>
        </div>      
      </div>
    
      <div class="item">
        <img src="Mercedes-Benz-Wallpaper-3-1920x1200.jpg" alt="BENZ" width="1200" height="700">
        <div class="carousel-caption">
          <h1>THE NEW MECEDES-BENZ E-CLASS</h1>
          <p>>With the New BS VI engine</p>
        </div>      
      </div>
	  
	    <div class="item">
        <img src="wp1828681.jpg" alt="" width="1200" height="700">
        <div class="carousel-caption">
		 <h1>Convenience, now at your fingertips</h1>
		 <p>>Enjoy transparency on our services with Online Service Estimate</p>
        </div>      
	  ...
	  <div class="item">
        <img src="E-300-Sedan.gif" alt="" width="1200" height="700">
        <div class="carousel-caption">
		 <h1>Convenience, now at your fingertips</h1>
		 <p>>Enjoy transparency on our services with Online Service Estimate</p>
        </div>      
	  ...
	  <div class="item">
        <img src="offrading.jpg" alt="" width="1200" height="700">
        <div class="carousel-caption">
		 <h1>Convenience, now at your fingertips</h1>
		 <p>>Enjoy transparency on our services with Online Service Estimate</p>
        </div>      
      ...
      <div class="item">
        <img src="inner.jpg" alt="" width="1200" height="700">
        <div class="carousel-caption">
		 <h1>Convenience, now at your fingertips</h1>
		 <p>>Enjoy transparency on our services with Online Service Estimate</p>
        </div>      
	 ...
	 <div class="item">
        <img src="carpixel.net-2014-mercedes-benz-concept-coupe-suv-10333-wide.jpg" alt="" width="1200" height="700">
        <div class="carousel-caption">
		 <h1>Convenience, now at your fingertips</h1>
		 <p>>Enjoy transparency on our services with Online Service Estimate</p>
        </div>      
...
<div id="tour" class="bg-1">
    ...
    <div class="row text-center">
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="SSPIP62173_MQ6_253905_large.png" alt="C-Class" width="400" height="300">
          <p><strong>C-Class</strong></p>
          <p>Starting from $40,20,000</p>
          <button class="btn" ><a  href="e-class.php"> LEARN MORE</a></button>
		  <button class="btn"  >TEST DRIVE</button>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="SSPIP62173_MQ6_253905_large.png" alt="GLC" width="400" height="300">
          <p><strong>GLC</strong></p>
          <p>Starting from $52,11,600</p>
          <button class="btn" data-toggle="modal" data-target="#myModal">LEARN MORE</button>
		  <button class="btn" data-toggle="modal" data-target="#myModal">TEST DRIVE</button>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="thumbnail">
          <img src="mercedes-drawing-suv-2.png" alt="GLE" width="400" height="300">
          <p><strong>GLE</strong></p>
          <p>Starting from $67,15,364</p>
          <button class="btn" data-toggle="modal" data-target="#myModal">LEARN MORE</button>
		  <button class="btn" data-toggle="modal" data-target="#myModal">TEST-DRIVE</button>
        </div>
      </div>
